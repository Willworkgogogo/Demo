...
func main() {
	...
	if config.ServeStatic {
		r.Static("/static/"+config.StaticServer.Version, "./static")
	}
...
func homepage(c *gin.Context) {
	c.HTML(http.StatusOK, "layout.html", pongo2.Context{
...
func aboutus(c *gin.Context) {
	c.HTML(http.StatusOK, "aboutus.html", pongo2.Context{
		"static_server_path": config.StaticServer,
	})
}

func plan(c *gin.Context) {
	c.HTML(http.StatusOK, "plan.html", pongo2.Context{
		"static_server_path": config.StaticServer,
	})
}
